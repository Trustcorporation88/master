...
- **Chamada a provedor precisa de teto de tempo.** A geração do código tem limite de 4 minutos; sem ele, uma chamada travada no provedor deixava o botão em "Preparando..." para sempre, porque o sinal de vida mantinha a conexão aberta indefinidamente. O botão também mostra um cronômetro: lento e travado precisam ser distinguíveis a olho.
