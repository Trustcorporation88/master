 ...
 *
 * Importa apenas de `publicTypes` — nada de `lib/providers`, `lib/duel/*` ou
 * `lib/search`. Isso é intencional: manter nomes de fornecedores, modelos e
 * estratégias fora do bundle que vai para o navegador.
 */
export default function Home() {
  ...
  const analisar = useCallback(async () => {
    ...
    try {
      const res = await fetch("/api/duel", {
        ...
        signal: ctrl.signal,
        body: JSON.stringify({ query: texto, profundidade }),
      });
  ...
  }, [podeEnviar, pergunta, profundidade, router]);
